...
#closeBtn{margin-bottom:3px; position:relative; top:2px; letf:-2px;}
#chatId{width:158px; height:24px; border:1px; solid #AAAAAA; background-color:#EEEEEE; padding:3px;}
