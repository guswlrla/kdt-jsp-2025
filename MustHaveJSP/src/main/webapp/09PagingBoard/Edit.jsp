...
if(pageNum == null) pageNum = "1"; // 기본값 1
...
if(!sessionId.equals(dto.getId())) {
	JSFunction.alertBack("작성자 본인만 작성할 수 있습니다.", out);
	return;
}
	...
	<table border="1" width="90%">
		...
		<tr>
			<td colspan="2" align="center">
				...
				<button type="button" onclick="location.href='List.jsp?pageNum=<%= pageNum %>'">목록 보기</button>
			</td>
		</tr>
	</table>
</form>
